...
interaction_features = [
    ...
    'interaction_btm_roic',
    'interaction_btm_volatility',
    'interaction_btm_vix'
]
...
df['interaction_btm_roic'] = df['book_to_market'] * df['roic_ihs']
df['interaction_btm_volatility'] = df['book_to_market'] * df['volatility_ihs']
df['interaction_btm_vix'] = df['book_to_market'] * df['vix_index_inverted']
...
features = columns_to_convert + interaction_features
